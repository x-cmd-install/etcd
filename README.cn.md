...
[![x-cmd/install — etcd Code Quality Monitoring Repo Card](https://repo.x-cmd.io/etcd.svg?lang=zh)](https://x-cmd.com/install/etcd)
...
合计: **180,496** 行代码（覆盖前 5 种语言、共 **1184** 个文件）。
...
- **Star**: 52,281 · **Fork**: 10,509 · **开放 issue**: 7,276 · **贡献者**: 987

## 累计统计

- **发布数**: 292 · **已合并 PR**: 10668 · **开放 PR**: 225 · **已关闭 issue**: 7147 · **开放 issue**: 129 · **提交数**: 25234
...
_数据快照: `data/card/260921.yml` · 2026-09-21T05:17:10Z._
